...
export function SolvearTurainChannels() {
  ...
  return (
    <section id="channels" className="py-20 md:py-28 relative bg-white border-b border-slate-200 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Active Channel Feature Showcase Card (Turain Design) */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              <div className="space-y-3">
                ...
                <p className="text-base text-slate-600 leading-relaxed font-normal">{activeChannel.description}</p>
              </div>
            ...
            <div className="lg:col-span-5 bg-white border border-slate-200 rounded-3xl p-8 space-y-6 text-center flex flex-col justify-between h-full shadow-md">
              ...
              <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200 text-left space-y-2.5 shadow-xs">
                <div className="flex items-center space-x-2 text-sm font-bold text-slate-900">
                  <Shield className="w-5 h-5 text-blue-600" />
                  <span>Meta &amp; Carrier Compliance</span>
                </div>
