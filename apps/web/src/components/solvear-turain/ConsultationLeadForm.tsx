...
export function SolvearTurainConsultationForm() {
  ...
  return (
    <section id="consultation" className="py-20 md:py-28 relative bg-white border-b border-slate-200 font-sans">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="space-y-4">
              <div className="inline-flex items-center space-x-2 bg-blue-50 border border-blue-200 px-4 py-1.5 rounded-full text-xs font-bold text-blue-800 font-mono">
                ...
                <span>Connect With Solvear Architects</span>
              </div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-slate-900 tracking-tight">
                Let’s Reach Out: Demo, Pricing &amp; Consultation
              </h2>
              <p className="text-base text-slate-600 leading-relaxed font-normal">
                Contact our communications team to configure your WhatsApp Cloud API, setup AI Bot flows, calculate eCommerce ROI, and activate white-label reseller licensing.
              </p>
            </div>
            ...
            <div className="space-y-4 text-sm">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-base font-extrabold text-slate-900">support@solvear.in</div>
                </div>
              </a>
            </div>
            ...
            <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200 space-y-3 shadow-xs">
              <div className="text-xs font-bold text-slate-700 uppercase tracking-wider flex items-center space-x-2">
                ...
                <span>Head Office &amp; Engineering Hubs:</span>
              </div>
              <div className="grid grid-cols-2 gap-3 text-xs text-slate-700 font-medium">
                <div>
                  <strong className="text-slate-900">India Operations:</strong>
                  <p className="text-slate-500">Tech Park, Sector V, Salt Lake, Kolkata</p>
                </div>
                <div>
                  <strong className="text-slate-900">Bengaluru Tech Hub:</strong>
                  <p className="text-slate-500">Outer Ring Road, Bellandur, Bengaluru</p>
                </div>
              </div>
            </div>
          </div>
            ...
            {submitted ? (
              <div className="text-center py-12 space-y-4 animate-in fade-in">
                ...
                <p className="text-sm text-slate-600 max-w-md mx-auto">
                  Thank you, <strong>{formData.name}</strong>. Our Solvear Solutions Architect will contact you at <strong>{formData.phone || formData.email}</strong> within 30 minutes with customized pricing &amp; sandbox credentials.
                </p>
                <button
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-slate-500">Fill in your details below for custom pricing, onboarding and demo access.</p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-white border border-slate-300 rounded-xl px-3.5 py-2.5 text-xs text-slate-900 focus:outline-none focus:border-blue-600 shadow-xs font-medium"
                    >
                      <option value="whatsapp_api">WhatsApp Cloud API &amp; Flows</option>
                      <option value="instagram_bot">Instagram DM Funnel</option>
                      <option value="ai_tokens">AI Bot Reply &amp; AI Tokens</option>
                      <option value="ecommerce">Shopify / WooCommerce COD &amp; Cart</option>
                      <option value="reseller">White-Label Reseller Solution</option>
                    </select>
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    rows={3}
                    placeholder="Tell us about your requirements (e.g. WooCommerce cart recovery, Meta Cloud API verification, DLT templates)..."
