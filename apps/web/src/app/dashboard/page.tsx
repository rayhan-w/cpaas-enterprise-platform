  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-zinc-850">
        <div>
          <h1 className="text-xl font-bold text-zinc-100 tracking-tight">Enterprise Telemetry & Overview</h1>
          <p className="text-xs text-zinc-400 mt-0.5">
            Real-time messaging telemetry, DLT compliance metrics, SMPP gateway latency, and operator dispatch status.
          </p>
        </div>
