      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="bg-[#C4737E] hover:bg-[#A85862] text-white font-bold text-xs px-4 py-2 rounded-xl transition-all shadow-sm flex items-center gap-1.5 active:scale-95"
          >
            ...
            <table className="w-full text-left text-xs">
              ...
              <tbody className="divide-y divide-[#F2EDEA]">
                {filteredProducts.map((prod) => (
                  <tr key={prod.id} className="hover:bg-[#FCF5F6]/40 transition-colors">
                    <td className="p-3">
                      <div className="flex items-center gap-3">
                        <img
                          src={prod.image}
                    ...
                    <td className="p-3">
                      {prod.badge ? (
                        <span className="bg-[#FCF5F6] text-[#C4737E] font-bold text-[10px] px-2 py-0.5 rounded-full border border-[#C4737E]/20">
                          {prod.badge}
                        </span>
                      ) : (
            ...
            <form onSubmit={handleAddProduct} className="space-y-3 text-xs">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#F8F7F5] border border-[#EDE5E1] rounded-xl px-3 py-2 text-[#1A1512] focus:outline-none focus:border-[#C4737E]"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-[#F8F7F5] border border-[#EDE5E1] rounded-xl p-3 text-[#1A1512] focus:outline-none focus:border-[#C4737E] resize-none"
                />
              </div>
              ...
              <div className="flex justify-end gap-2 pt-2 border-t border-[#EDE5E1]">
                ...
                <button
                  ...
                  className="bg-[#C4737E] hover:bg-[#A85862] text-white font-bold text-xs px-5 py-2 rounded-xl transition-all shadow-sm"
                >
