    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="bg-[#6CAE14] hover:bg-[#5B960E] text-white font-bold text-xs px-4 py-2.5 rounded-xl transition-all shadow-sm flex items-center gap-1.5 active:scale-95"
        >
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-[#F2EDEA]">
              {coupons.map((c) => (
                <tr key={c.id} className="hover:bg-[#F1F8E8]/40 transition-colors">
                  <td className="p-3 font-mono font-bold text-[#1A1512] text-sm">
                    <span className="bg-[#F1F8E8] text-[#6CAE14] px-2 py-1 rounded-md border border-[#6CAE14]/20">
                      {c.code}
                    </span>
                  </td>
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-8 max-w-md w-full border border-[#EDE5E1] shadow-2xl space-y-4 animate-modal-pop">
            ...
            <form onSubmit={handleAddCoupon} className="space-y-3 text-xs">
              ...
              <div className="flex justify-end gap-2 pt-3 border-t border-[#EDE5E1]">
                ...
                <button
                  type="submit"
                  className="bg-[#6CAE14] hover:bg-[#5B960E] text-white font-bold text-xs px-5 py-2 rounded-xl transition-all"
                >
                  Save Coupon
                </button>
              </div>
