    ...
    <div className="max-w-7xl mx-auto px-4 py-8 sm:py-12 space-y-8">
      ...
      {items.length === 0 ? (
        <div className="bg-white rounded-3xl p-12 text-center max-w-md mx-auto border border-[#EDE5E1] shadow-elevation-1 space-y-4">
          <div className="w-16 h-16 rounded-full bg-[#F1F8E8] flex items-center justify-center mx-auto text-[#6CAE14]">
          ...
          <Link
            href="/"
            className="inline-block bg-[#6CAE14] hover:bg-[#5B960E] text-white font-semibold text-xs px-6 py-3 rounded-full transition-colors"
          >
            Explore Marketplace
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <Link
                        ...
                        className="text-sm font-semibold text-[#1A1512] hover:text-[#6CAE14] transition-colors line-clamp-1"
                      >
                        {item.product.name}
                      </Link>
                      ...
                      <p className="text-xs font-bold text-[#6CAE14] mt-1 sm:hidden">
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg border font-semibold transition-all ${
                    deliveryZone === 'INSIDE_DHAKA'
                      ? 'bg-[#F1F8E8] border-[#6CAE14] text-[#6CAE14]'
          ...
          <div className="lg:col-span-4 space-y-4">
            <div className="bg-white rounded-3xl p-6 border border-[#EDE5E1] shadow-elevation-1 space-y-4">
              ...
              <Link
                href="/checkout"
                className="w-full flex items-center justify-center gap-2 bg-[#6CAE14] hover:bg-[#5B960E] text-white font-bold text-xs py-3.5 px-4 rounded-xl transition-all shadow-md active:scale-95 text-center"
              >
