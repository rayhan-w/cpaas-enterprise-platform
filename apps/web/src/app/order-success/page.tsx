    ...
    <div className="max-w-3xl mx-auto px-4 py-12 sm:py-16 space-y-8">
      ...
      <div className="bg-white rounded-3xl p-8 sm:p-12 border border-[#EDE5E1] shadow-elevation-2 text-center space-y-6">
          ...
          {order && (
            <>
              <div className="flex justify-between items-center text-xs">
                ...
                <span className="font-bold text-[#6CAE14]">{formatPrice(order.total)}</span>
              </div>
              <div className="flex justify-between items-center text-xs">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
          ...
          <Link
            href="/"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-white hover:bg-[#F1F8E8] text-[#1A1512] border border-[#EDE5E1] hover:border-[#6CAE14] font-semibold text-xs py-3.5 px-6 rounded-full transition-all active:scale-95"
          >
        ...
        <p className="text-xs text-[#9B8A86] pt-4">
          ...
          <a href="tel:01700000000" className="text-[#6CAE14] font-semibold hover:underline">
            01700-000000
          </a>
        </p>
      </div>
